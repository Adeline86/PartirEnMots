    ...
    jours: [
      {
        ...
        photos: [
          { photo: "photos/cotswolds-2026/j1-01.jpg", tag: "Bibury", titre: "Le ruisseau Coln longe les jardins", texte: "L'eau est partout à Bibury — le Coln traverse le village avec une discrétion que démentent ses reflets. On s'est arrêtés longtemps sur le petit pont." },
          { photo: "photos/cotswolds-2026/j1-02.jpg", tag: "Bibury", titre: "Les pierres et les fleurs de mai", texte: "Mai est le meilleur mois pour les Cotswolds. Les jardinières débordent, les grimpantes couvrent les façades, et la pierre dorée contraste avec le vert vif du printemps." },
          { photo: "photos/cotswolds-2026/j1-03.jpg", tag: "Bibury", titre: "Une façade, cent nuances de beige", texte: "La pierre calcaire des Cotswolds change de couleur selon la lumière — dorée le matin, miel à midi, presque rose au coucher du soleil." },
          { photo: "photos/cotswolds-2026/j1-04.jpg", tag: "Bibury", titre: "Le moulin à eau de Bibury", texte: "L'ancien moulin à truite de Bibury est l'un des bâtiments les plus anciens du village. L'eau tourbillonne encore dans les bassins comme si le temps s'était arrêté." },
          { photo: "photos/cotswolds-2026/j1-05.jpg", tag: "Bibury", titre: "Jardins et haies bien taillées", texte: "Les jardins anglais ont cette façon d'être à la fois ordonnés et généreux — tout pousse avec exubérance dans un cadre très structuré." },
          { photo: "photos/cotswolds-2026/j1-06.jpg", tag: "Bibury", titre: "La lumière de la fin d'après-midi", texte: "Vers 18h, la lumière de mai rase les toits et allume les façades. C'est l'heure où les villages des Cotswolds sont les plus beaux." },
          { photo: "photos/cotswolds-2026/j1-07.jpg", tag: "Bibury", titre: "Détails de pierre", texte: "On finit par regarder les détails — le grain de la pierre, les lichens sur les murs, les joints centenaires. Chaque façade est un peu différente." },
          { photo: "photos/cotswolds-2026/j1-08.jpg", tag: "Bibury", titre: "Le soir tombe sur Arlington Row", texte: "On est restés jusqu'à la fermeture du soleil. Dernier regard sur Arlington Row avant de rentrer. Demain, les Cotswolds commencent vraiment." },
          { photo: "photos/cotswolds-2026/j1-09.jpg", tag: "Bibury", titre: "Premiers pas dans le village qui ressemble à une aquarelle", texte: "Bibury pour poser les valises — et déjà, la surprise. Arlington Row, ses maisons en pierre du 14e siècle le long du ruisseau Coln, la lumière de fin de journée. On ne s'attendait pas à être aussi vite conquis." },
        ],
      },
      {
